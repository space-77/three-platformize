import { WebGLRenderTarget, HalfFloatType, ShaderMaterial, UniformsUtils, NoBlending, MeshNormalMaterial, DstColorFactor, ZeroFactor, AddEquation, DstAlphaFactor, CustomBlending, Color, DepthTexture, DepthStencilFormat, UnsignedInt248Type, NearestFilter, DataTexture, RGBAFormat, UnsignedByteType, RepeatWrapping } from '../../../build/three.module.js';
import { Pass, FullScreenQuad } from './Pass.js';
import { generateMagicSquareNoise, GTAOShader, GTAODepthShader, GTAOBlendShader } from '../shaders/GTAOShader.js';
import { PoissonDenoiseShader, generatePdSamplePointInitializer } from '../shaders/PoissonDenoiseShader.js';
