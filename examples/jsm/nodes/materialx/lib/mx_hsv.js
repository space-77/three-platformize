import { tslFn, vec3, float, If, int } from '../../shadernode/ShaderNode.js';
import { mul, sub, add } from '../../math/OperatorNode.js';
import { floor, trunc, min, max } from '../../math/MathNode.js';
